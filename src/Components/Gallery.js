...
<div class="container  ">
  <div style={{marginLeft: "30px"}} class="row  ">
    <div class="col">
    <img width = "300" height = "300" src="artshow.png" class="gallery-item" alt="gallery"/>
    ...
    <div class="col">
    <img width = "300" height = "300" src="https://picsum.photos/id/1037/300" class="gallery-item" alt="gallery"/>
